        ...
        <div className="flex h-[calc(100vh-8rem)] bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className={`w-full md:w-80 border-r border-gray-100 flex flex-col ${selectedConversationId ? 'hidden md:flex' : 'flex'}`}>
                <div className="p-4 border-b border-gray-100 bg-gray-50/50">
                    <h2 className="font-bold text-lg text-gray-900">Messages (Espace Pro)</h2>
                </div>
                        ...
                        conversations.map(conv => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`p-4 border-b border-gray-50 hover:bg-gray-50 cursor-pointer transition flex gap-3 ${isSelected ? 'bg-orange-50/50 border-l-4 border-l-orange-600' : ''}`}
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-start mb-1">
                                            <h3 className={`font-semibold text-sm truncate ${isSelected ? 'text-orange-900' : 'text-gray-900'}`}>
            ...
            {selectedConversationId ? (
                            ...
                            return (
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-xs text-green-600 flex items-center gap-1">Client</span>
                                    </div>
                                </div>
                            );
                        })()}
                    ...
                    <div className="p-3 bg-white border-t border-gray-100">
                        <form onSubmit={handleSendMessage} className="flex gap-2">
                            <Input
                                ...
                                disabled={isSending}
                            />
                            <Button type="submit" size="icon" disabled={!newMessage.trim() || isSending} className="bg-orange-600 hover:bg-orange-700 shrink-0">
                ...
                <div className="hidden md:flex flex-1 flex-col bg-gray-50/50 items-center justify-center text-gray-400">
                    ...
                    <p className="text-sm mt-1">pour échanger avec vos clients</p>
                </div>
            )}
        </div>
    );
